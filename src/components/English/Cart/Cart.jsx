    ...
    <Container sx={{height:'90dvh',overflow:'auto'}}>
        <Box sx={{padding:'2rem'}}>
            ...
            <Image src={Stock1} layout="fill" objectFit="cover"  alt='events'/>
              ...
              <Box sx={{display:'flex',alignItems:'center',justifyContent:'end',paddingTop:'1rem'}}>
               <Button sx={{fontFamily:'Rubik',fontSize:'15px',fontWeight:'400',background:'linear-gradient(to right, #f3904f, #3b4371)',textTransform:'none',width:'30%',color:'#fff','&:hover':{background:'linear-gradient(to right, #f3904f, #3b4371)',color:'#fff'}}}>Review Booking </Button>
              </Box>
               </Box>
              </Box>
